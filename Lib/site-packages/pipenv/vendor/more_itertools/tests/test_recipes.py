...
class AccumulateTests(TestCase):
    ...
    def test_empty(self):
        """tests that an empty input returns an empty output"""
        self.assertEqual(list(mi.accumulate([])), [])

    def test_default(self):
        """tests accumulate with the default function (addition)"""
        self.assertEqual(list(mi.accumulate([1, 2, 3])), [1, 3, 6])

    def test_bogus_function(self):
        """tests accumulate with an invalid function"""
        with self.assertRaises(TypeError):
            list(mi.accumulate([1, 2, 3], func=lambda x: x))

    def test_custom_function(self):
        """tests accumulate with a custom function"""
        self.assertEqual(
...
class GrouperTests(TestCase):
    ...
    def test_even(self):
        """tests when group size divides evenly into the length of
        the iterable.
    ...
    def test_odd(self):
        """tests when group size does not divide evenly into the length of the
        iterable.
    ...
    def test_fill_value(self):
        """tests that the fill value is used to pad the final group"""
        self.assertEqual(
...
class PartitionTests(TestCase):
    ...
    def test_bool(self):
        """tests when pred() returns a boolean"""
    ...
    def test_arbitrary(self):
        """tests when pred() returns an integer"""
...
class FirstTrueTests(TestCase):
    ...
    def test_default(self):
        """tests with a default keyword"""
        self.assertEqual(mi.first_true([0, 0, 0], default='!'), '!')

    def test_pred(self):
        """tests with a custom predicate"""
        self.assertEqual(
