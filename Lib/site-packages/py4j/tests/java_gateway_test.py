...
class CloseTest(unittest.TestCase):
    def testNoCallbackServer(self):
        # tests that the program can continue to move on and that no close
        # is required.
        JavaGateway()
...
class GatewayLauncherTest(unittest.TestCase):
    ...
    def testRedirectToNull(self):
        ...
        for i in range(4097):  # Hangs if not properly redirected
            self.gateway.jvm.System.out.println("tests")
    ...
    def testRedirectToQueue(self):
        ...
        sleep()
        for i in range(10):
            self.assertEqual("tests{0}".format(end), qout.get())
    ...
    def testRedirectToDeque(self):
        ...
        sleep()
        for i in range(10):
            self.assertEqual("tests{0}".format(end), qout.pop())
    ...
    def testRedirectToFile(self):
        ...
        try:
            ...
            # tests that the redirect files were written to correctly
            with open(outpath, "r") as stdout:
                lines = stdout.readlines()
                self.assertEqual(10, len(lines))
                self.assertEqual("tests{0}".format(end), lines[0])
