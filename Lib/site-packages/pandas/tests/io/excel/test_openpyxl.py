...
def test_append_mode_file(ext):
    ...
    with tm.ensure_clean(ext) as f:
        ...
        # "docProps/modules.xml" only occurs twice in the file
        data = Path(f).read_bytes()
        first = data.find(b"docProps/modules.xml")
        second = data.find(b"docProps/modules.xml", first + 1)
        third = data.find(b"docProps/modules.xml", second + 1)
