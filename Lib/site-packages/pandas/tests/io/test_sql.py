...
class TestSQLApi(SQLAlchemyMixIn, _TestSQLApi):
    """
    tests the public API as it would be used directly
...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    """
    tests the public sqlite connection fallback API
...
class _TestSQLiteAlchemy:
    """
    tests the sqlalchemy backend against an in-memory sqlite database.
...
class _TestMySQLAlchemy:
    """
    tests the sqlalchemy backend against an MySQL database.
...
class _TestPostgreSQLAlchemy:
    """
    tests the sqlalchemy backend against an PostgreSQL database.
...
# -----------------------------------------------------------------------------
# -- tests Sqlite / MySQL fallback


@pytest.mark.single
class TestSQLiteFallback(SQLiteMixIn, PandasSQLTest):
    """
    tests the fallback mode against an in-memory sqlite database.
