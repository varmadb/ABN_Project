...
>>> conf = SparkConf()
>>> conf.setMaster("local").setAppName("My modules")
<pyspark.conf.SparkConf object at ...>
>>> conf.get("spark.master")
u'local'
>>> conf.get("spark.modules.name")
u'My modules'
...
class SparkConf(object):
    ...
    you can write C{conf.setMaster("local").setAppName("My modules")}.
    ...
    def setAppName(self, value):
        ...
        self.set("spark.modules.name", value)
        return self
