...
class StreamingContextTests(PySparkStreamingTestCase):
    ...
    def test_get_active_or_create(self):
        # tests StreamingContext.getActiveOrCreate() without checkpoint data
...
class KafkaStreamTests(PySparkStreamingTestCase):
    ...
    def test_kafka_stream(self):
        """tests the Python Kafka stream API."""
    ...
    def test_kafka_direct_stream(self):
        """tests the Python direct Kafka stream API."""
        topic = self._randomTopic()
    ...
    def test_kafka_direct_stream_from_offset(self):
        """tests the Python direct Kafka stream API with start offset specified."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
    ...
    def test_kafka_rdd(self):
        """tests the Python direct Kafka RDD API."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2}
    ...
    def test_kafka_rdd_with_leaders(self):
        """tests the Python direct Kafka RDD API with leaders."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
        offsetRanges = [OffsetRange(topic, 0, long(0), long(sum(sendData.values())))]
        kafkaParams = {"metadata.broker.list": self._kafkaTestUtils.brokerAddress()}
    ...
    def test_kafka_rdd_get_offsetRanges(self):
        """tests Python direct Kafka RDD get OffsetRanges."""
        topic = self._randomTopic()
    ...
    def test_kafka_direct_stream_foreach_get_offsetRanges(self):
        """tests the Python direct Kafka stream foreachRDD get offsetRanges."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
        kafkaParams = {"metadata.broker.list": self._kafkaTestUtils.brokerAddress(),
                       "auto.offset.reset": "smallest"}
    ...
    def test_kafka_direct_stream_transform_get_offsetRanges(self):
        """tests the Python direct Kafka stream transform get offsetRanges."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
        kafkaParams = {"metadata.broker.list": self._kafkaTestUtils.brokerAddress(),
                       "auto.offset.reset": "smallest"}
        ...
        # tests whether it is ok mixing KafkaTransformedDStream and TransformedDStream together,
    ...
    def test_kafka_direct_stream_transform_with_checkpoint(self):
        """tests the Python direct Kafka stream transform with checkpoint correctly recovered."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
        kafkaParams = {"metadata.broker.list": self._kafkaTestUtils.brokerAddress(),
                       "auto.offset.reset": "smallest"}
    ...
    def test_kafka_rdd_message_handler(self):
        """tests Python direct Kafka RDD MessageHandler."""
        topic = self._randomTopic()
    ...
    def test_kafka_direct_stream_message_handler(self):
        """tests the Python direct Kafka stream MessageHandler."""
        topic = self._randomTopic()
        sendData = {"a": 1, "b": 2, "c": 3}
        kafkaParams = {"metadata.broker.list": self._kafkaTestUtils.brokerAddress(),
                       "auto.offset.reset": "smallest"}
