...
class SparkContext(object):
    ...
    def __init__(self, master=None, appName=None, sparkHome=None, pyFiles=None,
        ...
        """
        Create a new SparkContext. At least the master and modules name should be set,
    ...
    def _do_init(self, master, appName, sparkHome, pyFiles, environment, batchSize, serializer,
        ...
        if not self._conf.contains("spark.modules.name"):
            raise Exception("An application name must be set in your configuration")

        # Read back our properties from the conf in case we loaded some of them from
        # the classpath or an external config file
        self.master = self._conf.get("spark.master")
        self.appName = self._conf.get("spark.modules.name")
            ...
            if instance:
                if (SparkContext._active_spark_context and
                    ...
                    raise ValueError(
                        ...
                        "existing SparkContext(modules=%s, master=%s)"
                        " created by %s at %s:%s "
    ...
    def __enter__(self):
        """
        Enable 'with SparkContext(...) as sc: modules(sc)' syntax.
        """
        return self

    def __exit__(self, type, value, trace):
        """
        Enable 'with SparkContext(...) as sc: modules' syntax.
    ...
    def applicationId(self):
        ...
        * in case of local spark modules something like 'local-1433865536131'
